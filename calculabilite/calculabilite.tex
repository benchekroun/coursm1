...
\item etc...
\end{itemize}
\paragraph{Démonstration} Par l'absurde, supposons qu'il existe une propriété non-triviale P dont l'ensemble des MT qui la satisfait est récursif  .Montrons alors que K est récursif.
\end{document}