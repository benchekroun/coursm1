...
\section{Notions}
\paragraph{}
Machines de Turing à 1 ruban ,déterministe.\\Fonction calculable$f:\Sigma^*->\Sigma^*$(partielle)\\Langage $L\subseteq\Sigma^*$ récursif, reconnu par une MT TOTALE au sens fort\\Langage récursivement énumérable, reconnu au sens faible\\Problème décidable , langage récursif\\Problème indécidable, langage non-récursif\\On a montré que le problème de l'arret est indécidable\\Théorème de Rice : tout problème qui caractérise les MT dont la fonction satisfait une certaine propriété est soit trivial, soit indécidable\\Notion de réduction , $\leq_m$. Pour montrer P indécidable, on montre ARRET $\leq_m$ P.\\Théorème de récursion. 
\end{document}