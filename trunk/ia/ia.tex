...
\section{2 Avril 2013}
\subsection{Agents Logiques}
\paragraph{} la logique propositionnelle est déclarative : les éléments syntaxiques correspondent à des faits\\ Elle permet de décrire des info sous forme négative, conjonctive et disjonctive\\Elle est compositionnelle.
