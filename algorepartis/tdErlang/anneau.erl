...
-export([create/4,init/3,walk/2,launch/4]). 
...
%fonction de lancement, create puis !start(envoi de start) a tous
launch(Mod,Fun,Uid,N) ->
	{Z,[Y|L]} <- create(Mod,Fun,Uid,N),
	{Z,[Y|L]} ! start.
